...
- Ограничения: из-за кубической сложности препроцессинга O(N^3) алгоритм Map Based не запускался для N > 1000
...
Алгоритм на карте был принудительно остановлен на N=1000, так как при N>1000 расчетное время подготовки превысило бы разумные пределы тестирования. На графиках поиска заметны колебания - это нормальный системный шум при замерах малых интервалов времени.
